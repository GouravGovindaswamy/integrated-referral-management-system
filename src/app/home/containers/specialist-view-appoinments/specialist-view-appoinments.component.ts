...
@Component({
  selector: 'app-specialist-view-appoinments',
  templateUrl: './specialist-view-appoinments.component.html',
  styleUrls: ['./specialist-view-appoinments.component.css'],
  animations:[
    trigger('flyInOut', [
      transition('void => *', [
...
export class SpecialistViewAppoinmentsComponent implements OnInit {
  ...
  async getData(){
    ...
    let data = await this.service.specialistViewAppoinments();
